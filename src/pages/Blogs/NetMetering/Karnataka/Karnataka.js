   ...
   return (
      <Wrapper>
         ...
         <Container maxWidth='lg'>
            <Para>
               Karnataka is the seventh largest state located in the
               southern-western part in the country and one of the high
               contributors of commissioned solar power. Solar energy plants
               meet about 20 per cent of Karnataka’s daily power requirements as
               the overall share of renewables continues to climb. At 7,346
               megawatts (MW), the state has the largest installed capacity of
               solar power in the country, and the biggest local plant is in
               Pavagada (Tumakuru). In order to pursue the target several solar
               parks, schemes such as the Surya Raitha, awareness drives for the
               farmer as well as a keen focus towards distributed solar have
               been started. According to data from Karnataka Power Corporation
               Limited, solar energy accounts for more than 50 per cent of the
               state’s installed capacity of green energy (13,544 MW).
            </Para>
            ...
            >
               <Para sx={{ mb: 3 }}>
                  ...
                  industrial establishments through net metering and gross
                  metering methods based on tariff orders issued by KERC from
                  time to time.
               </Para>
               <ListingWithHand>
                  <span>👉</span>
                  Solar PV system shall be within the permissible rated capacity
               ...
               <ListingWithHand>
                  <span>👉</span>
                  Solar PV system shall interconnect and operate safely in
                  parallel with the distribution licensee network.
               </ListingWithHand>
               <ListingWithHand>
                  <span>👉</span>
                  In case of solar rooftop PV systems connected to the grid of a
                  distribution company on a net basis, the surplus energy
                  injected shall be paid by the ESCOMs at a tariff determined by
                  KERC from time to time.
               </ListingWithHand>
               <ListingWithHand>
                  <span>👉</span>
                  Metering shall be in compliance with the CEA (installations
                  and operation of meters) Regulations 2006, the Grid Code, the
               ...
               <ListingWithHand>
                  ...
                  connectivity to the network. The scheme shall be administered
                  by respective ESCOM’s. (including registration, approval,
                  metering, protocols, safety protocol, and standards).
               </ListingWithHand>
               <ListingWithHand>
                  <span>👉</span>
                  Fiscal benefits by the way of state and MNRE subsidies shall
                  be through nodal agency.
               </ListingWithHand>
            </BlogTitledBox>
               ...
               <Grid item xs={12} md={6}>
                  <ApprovalBox>
                     ...
                     <Ol type='1'>
                        ...
                        <li>
                           <Typography>
                              In the “Solar Rooftop Online Services” section,
                              apply for the “New Solar rooftop connection”
                           </Typography>
                        </li>
                        <li>
                           <Typography>
                              Pay the form fees of Rs. 1770/- and check
                              application
                           </Typography>
                        </li>
                     </Ol>
            ...
            <TableWrapper>
               <TableBox>
                  ...
                  <DataBox2>
                     Residential sector (above 3 KW capacity and upto 10 KW
                     capacity
                  </DataBox2>
                  <DataBox>
                     40% upto 3 KW + 20% for RTS system above 3 KW and upto 10
                     KW
                  </DataBox>
                  <DataBox2>
                     Group Housing Societies/ Residential Welfare associations
                     (GHS/ RWA) etc., for common facilities upto 500 KWP (@10
                     KWP per house), with the upper limit being inclusive of
                     individual rooftop plants already installed by individual
                     residents in that GHS/ RWA at the time of installation of
                     ...
                     <Box sx={{ mt: 0 }}>
                        ...
                        <GrayBox>
                           <ul>
                              ...
                              <li>
                                 <Typography>
                                    LT Consumers (Three Phase): Above 5 kWp to
                                    50 kWp
                                 </Typography>
                              </li>
                              <li>
                     ...
                     <Box sx={{ mt: 4 }}>
                        ...
                        <GrayBox>
                           <ul>
                              ...
                              <li>
                                 <Typography>
                                    All electricity injected in the grid shall
                                    be paid at applicable tariff rates
                                 </Typography>
                              </li>
                           </ul>
                        </GrayBox>
                     ...
                     <Box sx={{ mt: 4 }}>
                        ...
                        <GrayBox>
                           <ul>
                              <li>
                                 <Typography>
                                    Exempted from wheeling, banking, cross
                                    subsidy charges if applicable
                                 </Typography>
                              </li>
                           </ul>
                        </GrayBox>
