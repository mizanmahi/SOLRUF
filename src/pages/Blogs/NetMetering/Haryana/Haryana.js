    ...
    <Wrapper>
      ...
      <Container maxWidth="lg" sx={{ padding: { sm: "20px", xs: 0 } }}>
        <Para sx={{ padding: { xs: "20px", sm: 0 } }}>
          Haryana is an agrarian state with several geographical constraints
          such as high cost and paucity of barren land within its borders, with
          low potential for wind or hydropower. The state has shifted focus
          mainly on rooftop solar projects and small-scale distributed solar
          systems besides exploring the potential of megawatt-scale solar
          projects and parks. The last budget had announced a scheme to install
          50,000 off-grid solar pumps of 3 HP to 10 HP capacity in the State,
          with installation of 15,000 pumps and 35,000 pumps in two phases. The
          State government under the Pradhan Mantri Kisan Urja Surksha Evam
          Utthan Mahabhiyaan (PM-KUSUM) Scheme is providing 75% subsidy, of
          which 30% subsidy is provided under PM-KUSUM and 45% from the state.
          The state of Haryana has set a target of 3200 MW of solar power to be
          generated by the year 2021-22. The current installed and commissioned
          solar capacity of the state is 73.27 MW.
        </Para>
        ...
        >
          <ListingWithHand>
            <span>👉</span>
            he eligible consumer shall be within the permissible rated capacity
            as defined under these Regulations
          </ListingWithHand>
        ...
        >
          <Para sx={{ mb: 3 }}>
            Consumers across all categories including residential, commercial
            and industrial are now allowed to set-up solar projects with a
            maximum capacity of 2 MW. However, this comes with the condition
            that solar projects within the range of 1 to 2 MW must have 25%
            battery storage that should be able to store and deliver energy for
            2 hours.
          </Para>
          <ListingWithHand>
            <span>👉</span>
            The distribution capacity of transformers has been increased from
            30% and 15% to 50% and 30% for LT and HT consumers respectively.
          </ListingWithHand>

          <ListingWithHand>
            <span>👉</span>
            The DISCOMs will continue to provide net-metering arrangements to
            eligible consumers on a non-discriminatory and
            first-come-first-serve basis, as long as the total capacity of
            rooftop solar systems does not exceed 500 MW, up from the figure of
            200 MW.
          </ListingWithHand>
          <ListingWithHand>
            <span>👉</span>
            Rooftop solar systems commissioned under these regulations, whether
            self-owned or third-party owned, will be exempted from all wheeling,
            cross-subsidy, transmission, distribution, and banking charges and
            surcharges.
          </ListingWithHand>
        </BlogTitledBox>
          ...
          <Grid item xs={12} md={6}>
            <ApprovalBox>
              ...
              <Ol type="1">
                <li>
                  <Typography>
                    Visit “Dakshin haryana bijli vitran nigam” (DHBVN):
                  </Typography>
                  <Button
                ...
                <li>
                  <Typography>
                    Apply for the “Solar Connection” and fill up the application
                    form. During application filing, please note that in Haryana
                    “the name of applicant on electricity bill and property
                    registry should be same”
                  </Typography>
                </li>
                <li>
                  <Typography>
                    After submitting the application form, pay the incurred
                    Challan on the ePayment website of DHBVN:
                    epayment.dhbvn.org.in. Check the application status from
                    time to time.
                  </Typography>
                </li>
              </Ol>
          ...
          <Grid item xs={12} md={6}>
            <DocumentBox sx={{ padding: { sm: 0, xs: "20px" } }}>
              ...
              <UtilityList>
                <DoneIcon />
                <Typography>
                  Aadhar card and any other document if address differ from
                  Aadhar card
                </Typography>
              </UtilityList>
              <UtilityList>
              ...
              <UtilityList>
                <DoneIcon />
                <Typography>
                  For other than domestic sector: Registration Certificate,
        ...
        <TableWrapper>
          <TableBox>
            ...
            <DataBox2>
              Approximate annual saving on energy (Rs.) (Tariff taken as Rs. 7.5
              per unit)
            </DataBox2>
              ...
              <Box sx={{ mt: 4 }}>
                ...
                <GrayBox>
                  <ul>
                    <li>
                      <Typography>
                        Mandatory for new residential buildings having plot size
                        more than 500 sq. yards to install 3% to 5% capacity of
                        their Sanctioned Load on solar.
                      </Typography>
                    </li>
                    <li>
                      <Typography>
                        No permission is required from the building plan
                        sanctioning authority forsetting up of rooftop solar
                        power plants.
                      </Typography>
                    </li>
                    <li>
