            ...
            <Grid container spacing={2}>
               ...
               <Grid item xs={12} md={9}>
                  <Typography>
                     ...
                     the earth's surface is enough to power the entire world's
                     energy usage for a year. Solar power is the conversion of
                     solar energy into electrical energy. This energy can be
                     harnessed using solar technologies for a multitude of
                     purposes; photovoltaic, solar heating and cooling, and
                     concentrating solar power. Photovoltaic employs an
                     electronic method to create electricity directly from
                     sunshine, which may be used to power anything. <br />{' '}
                     <br />
                     Let's look at the potential of photovoltaic (PV) technology
                     for generating electricity from sunlight. Individual PV
                     cells are composed of a variety of semiconductor materials
                     and are typically thinner than four human hairs. Cells are
                     sandwiched between protective materials made of a
                     combination of glass and/or plastics to endure the elements
                     ...
                     <Grid container rowSpacing={3}>
                        ...
                        >
                           <BlogCard sx={{ maxWidth: 440 }} elevation='0'>
                              ...
                              <Box sx={{ p: 2 }}>
                                 <YellowButton onClick={() => navigate('/blogs/typesOfPvSystems')} >Read More</YellowButton>
                              </Box>
                           </BlogCard>
                        </Grid>
                        <Grid
                        ...
                        >
                           <BlogCard sx={{ maxWidth: 440 }} elevation='0'>
                              ...
                              <Box sx={{ p: 2 }}>
                                 <YellowButton onClick={() => navigate('/blogs/maintenance')} >Read More</YellowButton>
                              </Box>
                           </BlogCard>
                        </Grid>
                     </Grid>
