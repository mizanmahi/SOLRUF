         ...
         <Container maxWidth='xl'>
            <Grid container spacing={3}>
               ...
               <Grid item xs={12} md={9}>
                  <Typography>
                     Solar technologies use photovoltaic (PV) panels or solar
                     mirrors to catch the sun's radiation and convert it to
                     electrical energy. This energy can be used to create
                     electricity with intelligent photovoltaic systems or saved
                     in batteries or thermal storage. Solar photovoltaic (PV)
                     systems are made up of panels that absorb sunlight and
                     convert it to power. The DC signals are fed through an
                     inverter, which converts them to grid-safe AC power. For
                     safety purposes, various switch boxes are incorporated, and
                     everything is connected by wires and conduit.
                  </Typography>
                  <BlogCards>
                           ...
                           <BlogCard sx={{ maxWidth: 440 }} elevation='0'>
                              <Box>
                                 ...
                                 <CardContent>
                                    ...
                                    >
                                       A solar panel (also known as a solar
                                       module) consists of a layer of silicon
                                       cells, a metal frame, a..
                                    </Typography>
                                 </CardContent>
                              </Box>
                              <Box sx={{ p: 2 }}>
                              ...
                              <Box>
                                 ...
                                 <CardContent>
                                    ...
                                    <Typography
                                       ...
                                       color='text.secondary'
                                    >
                                       A solar inverter or PV inverter converts
                              ...
                              <Box>
                                 ...
                                 <CardContent>
                                    ...
                                    <Typography
                                       ...
                                       color='text.secondary'
                                    >
                                       Solar battery is a device that reserves
                                       energy for later consumption that is
                                       charged by a connected solar system.
                                       The...
                                    </Typography>
                                 </CardContent>
                              </Box>
                              ...
                              <Box>
                                 ...
                                 <CardContent>
                                    ...
                                    <Typography
                                       ...
                                       color='text.secondary'
                                    >
                                       Lightning (surge) arrestors are designed
                                       to absorb voltage spikes caused by
                                       electrical storms (or out-of-spec utility
                                       power)...
                                    </Typography>
                                 </CardContent>
                              </Box>
                              ...
                              <Box>
                                 ...
                                 <CardContent>
                                    ...
                                    <Typography
                                       ...
                                       color='text.secondary'
                                    >
                                       A Photovoltaic (PV) meter collects PV
                                       yield production to measure how much
                              ...
                              <Box>
                                 ...
                                 <CardContent>
                                    ...
                                    <Typography
                                       ...
                                       color='text.secondary'
                                    >
                                       Net meters work by continuously sampling
                              ...
                              <Box>
                                 ...
                                 <CardContent>
                                    ...
                                    <Typography
                                       ...
                                       color='text.secondary'
                                    >
                                       A cable is a group of two or more
                                       conductors that are twisted or bonded
                                       together, surrounded by an insulating...
                                    </Typography>
                                 </CardContent>
                              </Box>
                              <Box sx={{ p: 2 }}>
                              ...
                              <Box>
                                 ...
                                 <CardContent>
                                    ...
                                    <Typography
                                       ...
                                       color='text.secondary'
                                    >
                                       A Solar Junction Box is a protective box
                                       that is used to combine, connect, and
                                       terminate electrical components...
                                    </Typography>
                                 </CardContent>
                              </Box>
                              <Box sx={{ p: 2 }}>
                              ...
                              <Box>
                                 ...
                                 <CardContent>
                                    ...
                                    <Typography
                                       ...
                                       color='text.secondary'
                                    >
                                       Earthing is a way of transmitting any
                                       instant electricity discharge/ lightning
                                       directly to the ground through low
                                       resistance...
                                    </Typography>
                                 </CardContent>
                              </Box>
                              ...
                              <Box>
                                 ...
                                 <CardContent>
                                    ...
                                    <Typography
                                       ...
                                       color='text.secondary'
                                    >
                                       A solar charge controller is
                                       fundamentally a voltage or current
                                       controller to charge the battery and keep
                                       electric ..
                                    </Typography>
                                 </CardContent>
                              </Box>
                  ...
                  <Para>
                     A Solar PV Balance-of-System or BOS refers to the
                     components and equipment that move DC energy produced by
                     solar panels through the conversion system which in turn
                     produces AC electricity. This includes wiring, switches,
                     junction box, a mounting system, charge controller,
                     lightning arrestor, earthing electrode,etc.. BOS components
                     make up roughly 10%-50% of solar purchasing and
                     installation costs and account for the majority of
                     maintenance requirements. The components included in the
                     BOS are given below:
                  </Para>
