          ...
          <Grid container rowSpacing={3}>
                ...
                <Box>
                  ...
                  <CardContent>
                    ...
                    <Typography variant="body2" color="text.secondary">
                      Solar design is the representation of the photovoltaic
                      system characteristics such as civil and electrical
                      rendition including.
                    </Typography>
                  </CardContent>
                </Box>
                <Box sx={{ p: 2 }}>
                  <YellowButton onClick={() => navigate("/blogs/solarDesign")}>
                    Read More
                  </YellowButton>
                </Box>
              </BlogCard>
                ...
                <Box>
                  ...
                  <CardContent>
                    ...
                    <Typography variant="body2" color="text.secondary">
                      ...
                      sunlight and convert that light into electricity which..
                    </Typography>
                  </CardContent>
                </Box>
                <Box sx={{ p: 2 }}>
                  <YellowButton onClick={() => navigate("/blogs/solarSteps")}>
                    Read More
                  </YellowButton>
                </Box>
              </BlogCard>
              ...
              <BlogCard sx={{ maxWidth: 440 }} elevation="0">
                <Box>
                  ...
                  <CardContent>
                    ...
                    <Typography variant="body2" color="text.secondary">
                      Solar batteries are an additional component that allows
                      for the storage of solar photovoltaic energy, so we can
                      use it..
                    </Typography>
                  </CardContent>
                </Box>
                <Box sx={{ p: 2 }}>
                  <YellowButton
                    onClick={() => navigate("/blogs/solarInstallationProcess")}
                  >
                    Read More
                  </YellowButton>
                </Box>
              ...
              <BlogCard sx={{ maxWidth: 440 }} elevation="0">
                <Box>
                  ...
                  <CardContent>
                    ...
                    <Typography variant="body2" color="text.secondary">
                      Solar inverters are used to convert the direct current
                      (DC) electricity generated by solar photovoltaic modules
                      into..
                    </Typography>
                  </CardContent>
                </Box>
            ...
            >
              <BlogCard sx={{ maxWidth: 440 }} elevation="0">
                ...
                <Box sx={{ p: 2 }}>
                  <YellowButton onClick={() => navigate("/blogs/maintenance")}>
                    Read More
                  </YellowButton>
                </Box>
              </BlogCard>
              ...
              <BlogCard sx={{ maxWidth: 440 }} elevation="0">
                <Box>
                  ...
                  <CardContent>
                    ...
                    <Typography variant="body2" color="text.secondary">
                      The balance of system (BOS) refers to the components and
                      equipment that move DC energy produced by solar..
                    </Typography>
                  </CardContent>
                </Box>
                <Box sx={{ p: 2 }}>
