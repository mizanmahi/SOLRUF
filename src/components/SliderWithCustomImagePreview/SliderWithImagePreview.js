...
const SliderWithImagePreview = () => {
   ...
   return (
      <Box>
         <Slider {...settings}>
            <Box sx={{width: '100%'}}>
               <img src='https://i.ibb.co/SvZkB1S/Rectangle-35.png' alt='' style={{maxWidth: '100%',width: '100%', margin: '0 auto' }} />
            </Box>
            <Box sx={{width: '100%'}}>
               <img src='https://i.ibb.co/SvZkB1S/Rectangle-35.png' alt='' style={{maxWidth: '100%',width: '100%', margin: '0 auto' }} />
            </Box>
            ...
            <Box sx={{width: '100%'}}>
               <img src='https://i.ibb.co/SvZkB1S/Rectangle-35.png' alt='' style={{maxWidth: '100%',width: '100%', margin: '0 auto' }} />width: '100%',
            </Box>
...
export default SliderWithImagePreview;
