...
const PurchaseDetailsDrawer = ({
   ...
   const handleDetailsClick = (orderType, product) => {
      console.log(product);
      // return;
      if (orderType === 'CART') {
         navigate(
            `/purchase-product/${product?.product?.product_meta.vendor_slug}/${product?.product?.vendor_id}/${product?.product?.product_meta.product_slug}/${product?.product_id}`
         );
      }
   };
   ...
   const downloadInvoiceHandler = async () => {
      ...
      const inVoiceData = {
         ...
         buyer_website:
            purchaseDrawerData?.others?.billing?.company_name || 'n/a',
               ...
               <Box sx={{ mt: 2 }}>
                  ...
                  >
                     <Typography variant='h6' sx={{ mr: 2, fontWeight: 500 }}>
                        Order Reference:- <br />#
                        {purchaseDrawerData?.others?.reference}
                     </Typography>
                  ...
                  <Box>
                     {purchaseDrawerData?.others?.type === 'ENQUIRY' ? (
                        ...
                        <>
                           {purchaseDrawerData?.others?.details.length ===
                              1 && (
                              <>
                                 {matches ? (
                     ...
                     {purchaseDrawerData?.others?.details.length > 1 && (
                        <ListWrapper>
                           {purchaseDrawerData?.others?.details.map(
                              (item, index) => (
                                 <List
                                    sx={{
                                       width: '100%',
                              ...
                              <Box>
                                 <Box sx={{ my: 3, textAlign: 'center' }}>
                                    ...
                                    <Typography fontWeight={700} color='black'>
                                       ...
                                       confirmed. Please check if the ID entered
                                       is correct and wait for another 2hrs for
                                       confirmation.
                                    </Typography>
